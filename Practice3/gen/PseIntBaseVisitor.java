...
public class PseIntBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PseIntVisitor<T> {
	 ...
	 */
	@Override public T visitS(PseIntParser.SContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitSubprocess(PseIntParser.SubprocessContext ctx) { return visitChildren(ctx); }
}